...
`.trim(),
  ...
  // 2026-09-17, third batch — found by grepping the rendered bodies for the
  // bare word 「Mokaru」 rather than for the charter's vocabulary. These two are
  // the only articles in the archive whose TITLE is a sales pitch for us:
  // 「Mokaruが家族旅行におすすめの理由」and「行けるの？と思ったらMokaruに相談！」.
  // Every section under both titles is a reason to hire the van.
  "family-friendly": {
    was:
      "Mokaruが家族旅行におすすめの理由！子連れでも安心のサポートとは？ — " +
      "①予定変更に柔軟対応 ②買い物中は車でお子様が待機OK ③専用車が授乳＆おむつ替えスペース " +
      "④レストラン選びのサポート ⑤スケジュール調整自由。全項目が自社の車とガイド。",
    rewrittenAt: REWRITTEN_AT_SWEEP,
    title: "グアムの家族旅行｜1日の組み立て方と、先に取っておくもの",
    html: `
<p>家族でのグアムは、<strong>行き先より段取りで決まります</strong>。子どもは大人の予定どおりには動きません。崩れる前提で組んでおくと、崩れても旅が壊れません。</p>

<h2>1日に2〜3か所。それ以上は入れない</h2>
<p>大人だけなら4か所回れるところを、<strong>1つ減らして</strong>組みます。移動のたびに、乗り降り、トイレ、水分、機嫌の確認が入るからです。予定を1つ落とせる余白を最初から持っておくと、落としても「今日は失敗した」になりません。</p>
<p>うまくいきやすい形はだいたい決まっています。</p>
<ul>
<li><strong>午前</strong> — 外の予定。暑くなる前に済ませます</li>
<li><strong>昼過ぎ</strong> — 屋内か、宿に戻ってお昼寝。ここを削ると午後が全部崩れます</li>
<li><strong>夕方</strong> — ビーチか買い物。日が傾いてからのほうが過ごしやすいです</li>
</ul>

<h2>先に取っておくべきものは2つだけ</h2>
<p>移動手段や買い物は当日でもなんとかなります。<strong>当日ではどうにもならないのはこの2つ</strong>です。</p>
<ul>
<li><strong>人数の多い食事</strong> — 家族4人以上、祖父母も一緒なら6〜8人。人気店の夜の席は当日に電話して空いている話ではありません</li>
<li><strong>年齢制限や催行人数のあるアクティビティ</strong> — イルカウォッチングや体験ダイビングには年齢や身長の下限があります。当日に断られると、その日の予定が丸ごと空きます</li>
</ul>
<p>どちらも、<strong>申し込みのときに子どもの年齢を伝えておく</strong>のが肝心です。ベビーチェアの有無、キッズメニューの有無、年齢が下限に届くかどうか。あとから言うと、店も催行会社も動けません。</p>

<h2>食事は「入れる店」から決める</h2>
<p>グアムのレストランは、日本ほど子ども連れ前提の設備が整っていません。確認しておくと安心なのは次の点です。</p>
<ul>
<li>ベビーチェアがあるか</li>
<li>キッズメニューがあるか</li>
<li>離乳食の持ち込みができるか</li>
<li>席が奥か、通路側か（ぐずったときに出やすい席かどうか）</li>
</ul>
<p>子ども連れで入りやすいのは、<strong>シャーリーズ・キッチン</strong>、<strong>プロア</strong>、<strong>カフェ・キッチン</strong>あたりです。いずれも混むので、時間は早めに取っておくほうが確実です。</p>

<h2>おむつ替えと授乳の場所</h2>
<p>観光地やレストランには設備がない場所も少なくありません。整っているのは大きなショッピングモールです。</p>
<ul>
<li><strong>マイクロネシアモール</strong></li>
<li><strong>GPO（グアム・プレミア・アウトレット）</strong></li>
</ul>
<p>外を歩く日は、途中にモールを一度挟んでおくと安心です。休憩と涼みも兼ねられます。</p>

<h2>車に乗るなら、チャイルドシートは法律です</h2>
<p>グアムでは<strong>6歳未満の子どもにチャイルドシートの使用が義務づけられています</strong>。レンタカーなら予約時に申し込んでください。送迎つきのアクティビティを申し込む場合も、<strong>申し込みの時点で年齢を伝えて</strong>おけば、用意してもらえるかどうかを先に確認できます。</p>

<h2>まとめ</h2>
<p>家族旅行は、回った数ではなく無事に楽しく帰れたかで決まります。<strong>1日2〜3か所</strong>、<strong>昼過ぎに休む</strong>、<strong>食事とアクティビティだけ先に押さえる</strong>。この3つで、たいていの日はうまく回ります。</p>
`.trim(),
  },

  // 🔵 The subject here transfers to the new business almost unchanged. The
  // article answered「ここ行けるの？」with "yes, in our van". The question a
  // reader arrives with is the same one; only the honest answer changed, and
  // the honest answer now includes telling people what we canNOT get them.
  "special-requests": {
    was:
      "グアムで「行けるの？」と思ったらMokaruに相談！旅行会社が対応しない場所もOK — " +
      "①穴場スポット ②ローカルなお店 ③ローカルグルメ ④遠方エリア ⑤特別なリクエスト（ドローン撮影等）。" +
      "「完全プライベートの専用車＆日本語ガイド付きで自由にどこへでも」が全編の主張。",
    rewrittenAt: REWRITTEN_AT_SWEEP,
    title: "グアムで「これ予約できる？」と思ったら｜手配できるもの・できないもの",
    html: `
<p>旅行会社のパッケージに入っていないものを見つけると、「これは現地で頼めるんだろうか」と手が止まります。<strong>頼めるものと、頼めないものがあります。</strong>先に分かっていれば、旅程の組み方が変わります。</p>

<h2>先に押さえないと、当日はまず無理なもの</h2>
<ul>
<li><strong>人気レストランの席</strong> — とくに夜と、4名を超える人数。週末はさらに埋まります</li>
<li><strong>催行人数の決まったアクティビティ</strong> — ドルフィンウォッチング、体験ダイビング、パラセーリング。<strong>朝の便から埋まります</strong></li>
<li><strong>送迎つきのツアー</strong> — 前日までの申し込みを求める催行会社がほとんどです</li>
</ul>
<p>この3つは、<strong>行きたい日が決まった時点</strong>が申し込みどきです。現地に着いてからでは、空いている店と空いている時間に合わせることになります。</p>

<h2>当日でもなんとかなるもの</h2>
<ul>
<li>ビーチ、展望台、砦などの<strong>無料の観光地</strong>。恋人岬のような有料の展望台も当日で入れます</li>
<li>ショッピングモールと<strong>ローカルスーパー</strong></li>
<li>屋台やフードコートでの食事</li>
<li><strong>チャモロビレッジのナイトマーケット</strong>（ただし水曜の夜だけです）</li>
</ul>

<h2>予約では解決しないこと</h2>
<p>正直に書いておきます。<strong>足の問題は、予約では解決しません。</strong></p>
<p>タロフォフォの滝、イナラハン天然プール、リティディアンビーチ。この種の場所には路線バスが通っていません。行くなら<strong>レンタカー</strong>か、<strong>送迎のついたツアーを選ぶ</strong>か、<strong>タクシーを往復で確保する</strong>かのどれかになります。行き先を決める前に、そこまでの足があるかどうかを先に確かめてください。</p>
<p>夜も同じです。グアムはタクシーが流していません。夜の外出は、<strong>帰りの手段を出かける前に決めておく</strong>のが基本です。</p>

<h2>Mokaru に頼めること</h2>
<p>やっているのは2つです。</p>
<ul>
<li><strong>レストランの予約代行</strong> — 1件 $10。人数・時間・席の希望・アレルギー・お祝いの有無まで、日本語で伝えて先方と詰めます</li>
<li><strong>アクティビティの手配</strong> — 提携先への申し込みを代わって行います。手数料はいただきません（ツアー代金は実施会社へ直接お支払いいただきます）</li>
</ul>
<p>いずれも、<strong>日本にいるうちにメールだけで</strong>済みます。席が取れなかった場合、予約代行の料金はいただきません。</p>

<h2>まとめ</h2>
<p>「これ予約できる？」の答えは、<strong>時間が決まっているものは早く、決まっていないものは当日でいい</strong>、です。食事とアクティビティを先に押さえて、残りは着いてから決める。この順番で組むと、いちばん取りこぼしが少なくなります。</p>
`.trim(),
  },
};
