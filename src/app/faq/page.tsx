...
const FAQS: { q: string; a: string }[] = [
  ...
  {
    q: "どんなスポットに行けますか？",
    a: "恋人岬、スペイン広場、アプガン砦、エメラルドバレー、スロウウォークコーヒーなどが人気です。定番から南部の自然まで、ご希望に合わせて組み合わせられます。",
  },
  {
    q: "料金はどのように決まりますか？",
  ...
  {
    q: "予約はどのように進みますか？",
    a: "リクエスト予約制です。希望日時・人数・行きたいスポットをお送りいただき、ガイド・車両の空きを確認してご連絡します（48時間以内）。この時点では料金は発生しません。ご不明な点は LINE でもお気軽にご相談ください。",
  },
  {
    q: "キャンセルはできますか？",
